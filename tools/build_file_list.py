...
sys.path.append('/workspace/Hidden-Two-Stream')
from pyActionRecog import parse_directory, build_split_list
from pyActionRecog import parse_split_file

parser = argparse.ArgumentParser()
parser.add_argument('dataset', type=str, choices=['ucf101', 'hmdb51', 'activitynet_1.2', 'activitynet_1.3', 'alome'])
...
parser.add_argument('--out_list_path', type=str, default='/workspace/Hidden-Two-Stream/models/ucf101_split1_unsup_end/')
